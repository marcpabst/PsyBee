...
use super::uniform_structs::PixelFillterUniforms;
...
impl PixelFilter {
    ...
    pub fn uniforms(&self) -> PixelFillterUniforms {
        match self {
            PixelFilter::None => PixelFillterUniforms {
                filter_type: 0,
                filter_params: [0.0; 9],
            },
            ...
            PixelFilter::Threshold { threshold } => {
                todo!()
            }
            PixelFilter::GaussianEnvelope {
                center,
                sigma,
                rotation,
            } => PixelFillterUniforms {
                filter_type: 3,
                filter_params: [0.0; 9],
            },
        }
    ...
    /// Returns the size of the uniform buffer for a PixelFilter.
    pub fn uniform_len() -> usize {
        std::mem::size_of::<PixelFillterUniforms>()
    }
}
