...
// This module contains the video stimulus, which consists of a rectangular
// PatternStimulus with a video texture.
...
impl VideoStimulus {
    ...
    pub fn new(window: &Window,
               ...
               -> Self {
        let pattern = super::patterns::Video::new_from_path(video_path,
                                                            video_width,
                                                            video_height,
                                                            video_thumbnail,
                                                            video_init);
    ...
    pub fn init(&self) -> Result<(), PsybeeError> {
